...
then
    if ! curl -sfL https://raw.githubusercontent.com/Dieguim25/vm/refs/heads/main/lib.sh -o /var/scripts/lib.sh
    then
...
then
    curl -sfL https://raw.githubusercontent.com/Dieguim25/vm/refs/heads/main/lib.sh -o /var/scripts/lib.sh
fi
